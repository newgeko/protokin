...
```
     ...
     Kinesis                      Kinship
         │                           │
   la transformation           la filiation
                             et les dépendances
         │                           │
         └─────────────┬─────────────┘
                       │
...
```
PROTO                       KIN
Conditions matérielles  ⇅   Descriptions
Couplages organisme/   ⇅   Inférences et normes
  milieu               ⇅   Transformations historiques
Configurations         ⇅
  perceptives et
  pratiques
```
...
Ne pas confondre les conditions d'une description avec ce qu'elle décrit, ni la stabilité d'une description avec une essence immuable.
...
PROTOKIN EN UNE PHRASE
         │
         ▼
PROTOKIN — NOM, ORIGINE ET PORTÉE
         │
         ▼
STATUT DU PROJET
         │
...
Cette page établit le statut du nom Protokin comme orientation conceptuelle.
...
Ce que cette page ne prétend pas établir
