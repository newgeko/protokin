...
> Quelles conditions corporelles et matérielles sont engagées ?
Quelles relations sont établies ou transformées ?
Quelles fonctions ces relations remplissent-elles dans une pratique ?
Selon quelles raisons et quels critères cette pratique est-elle tenue pour correcte ou recevable ?
...
\[
\boxed{
\text{capacité relationnelle}
\neq
\text{engagement normatif}
}
\]
...
\text{révision de fonction}
\rightarrow
\text{réorganisation relationnelle}.
\]
...
Ces réductions ont une structure commune :

> une dimension est utilisée pour absorber le statut d'une autre.
...
\[
\boxed{
\text{théorie de la genèse de l'être}.
}
\]
