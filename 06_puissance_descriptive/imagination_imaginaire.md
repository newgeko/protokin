...
A[Content Layer : configurations disponibles]
--> B[Imagination : opérateur de variation]

H[Imaginaire historique : ressources descriptives]
--> B

B --> C[Hypothèses, analogies et scénarios possibles]

C --> D[Pratiques collectives de justification]

D --> E[Tests matériels et inférentiels]

E --> F[Stabilisation éventuelle]

F --> G[Régime descriptif]
