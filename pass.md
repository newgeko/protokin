...
Il met en œuvre une **suite d’opérations normées d’analyse structurelle** :

- segmentation ;
- identification des régimes ;
- détection des tensions ;
- analyse des transpositions modales ;
- activation du Kernel ;
- production de diagnostics de stabilité.
...
Découpage des unités de description pertinentes :
...
Chaque unité est associée à un régime de description probable :
...
### 3. Cartographie des engagements inférentiels

Pour chaque unité :

- identification des engagements ;
- identification des habilitations ;
- extraction des relations inférentielles locales.

---

### 4. Détection des tensions (CAP)

Le système identifie :

- incompatibilités entre régimes ;
- collisions de critères de validité ;
- surdéterminations descriptives.

---

### 5. Analyse des transpositions modales (OVM)

PASS active l’OVM pour détecter :

- réductions causalistes (T1) ;
- normativisations abusives (T2) ;
- substitutions du sujet (T3).

---

### 6. Activation du Kernel

Le Kernel :

- évalue la structure globale des tensions ;
- détermine la possibilité de transition ;
- stabilise ou signale une instabilité.

---

### 7. Détection de DELTA (si nécessaire)

Si aucune stabilisation n’est possible :

- activation de DELTA ;
- signal de rupture structurelle ;
- suspension des transitions.
...
Il transforme un corpus en :

> une cartographie structurée de régimes, tensions et conditions de stabilisation.
