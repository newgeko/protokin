...
La documentation doit combiner :

- la rigueur d'une encyclopédie philosophique ;
- la précision d'une documentation conceptuelle ;
...
# Objet général de Protokin

Protokin n'est :

- ni une ontologie générale du réel ;
- ni une théorie métaphysique des objets ;
...
- les configurations conceptuelles ;
...
> Comment une variation devient-elle une différence disponible pour une description ?

> Comment une communauté stabilise-t-elle une catégorie ?

> Comment un locuteur devient-il responsable d'une assertion ?
...
- espace des raisons (Sellars) ;
- inférentialisme (Brandom) ;
- énactivisme (Varela, Maturana) ;
- historical ontology (Hacking).
...
Un exemple n'est pas une preuve théorique.
