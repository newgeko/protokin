...
- Point d'origine des tensions T2 (avec R5) et T4 (avec R11).
...
- Erreur modale : postuler l'allostasie sans substrat dissipatif ouvert (R2).
...
- R2 — Dissipation structurée : R3 hérite du cadre énergétique des flux hors équilibre modélisé par R2.
- R7 — Préconditions du comportement : R3 offre les mécanismes de modulation à la stabilisation biologique globale de R7.
- R10 — Couplage structurel : R3 présente un recouvrement majeur en fournissant les processus biologiques de régulation proactive qui modifient la structure interne de l'agent pour maintenir la dérive viable.

Traductions stables

- R3 ↔ R12 : L'ajustement allostatique fournit les paramètres somatiques concrets dont l'Évaluation thimique (R12) traduit les variations en gradients de valeur affective pour guider le comportement.

Frictions cartographiées

- R5 — Minimisation de la surprise : Tension T2 (Traduction), liée au risque de réduire le régime allostatique matériel à une pure optimisation informationnelle et computationnelle abstraite.
- R6 — Récursion prospective : Friction autour de l'extension cognitive de l'anticipation, dépassant la simple physiologie.
- R9 — Effet cliquet culturel : Tension T10/T11, car l'inertie des innovations culturelles figées par le cliquet (R9) entre souvent en contradiction directe avec les besoins urgents de flexibilité et de modulation rapide des paramètres allostatiques de survie (R3).

Incompatibilités structurelles

- R11 — Rupture épistémologique : Incompatibilité radicale marquant le passage au domaine normatif qui est indépendant de la régulation biologique causale. Une tension fonctionnelle constante s'y observe : les exigences de cohérence logique (R11) peuvent pousser le système à maintenir des engagements symboliques au détriment de l'optimisation proactive de ses paramètres vitaux.
...
Ces tensions délimitent l'espace propre de R3 : il prouve que la simple thermodynamique réactive (R2) ne suffit pas à définir le vivant, qui est avant tout anticipatif. Parallèlement, R3, en tant que régime causal d'ajustement, met en lumière (T4) qu'une anticipation physiologique de survie n'est pas encore une justification rationnelle ou une norme intellectuelle.
...
Les ajustements physiologiques et moteurs prospectifs de R3 deviennent des conditions matérielles de possibilité pour asseoir l'attention partagée et l'intentionnalité collective.

Vu depuis R12 (Évaluation thimique)

Le régime R3 est relu comme la grammaire neurobiologique fondamentale documentant les états de déviation ou d'adéquation physiologique ; ces états seront ensuite convertis par R12 en valences affectives et en urgences d'action.
...
- Tension secondaire : T4 (Normative, face à R11)

Transitions fréquemment observées

- R3 → R5 par émergence (passage du réglage paramétrique à l'inférence prédictive formelle).
- R3 → R12 par réinterprétation (traduction de l'écart physiologique en valence thimique primitive).
- Blocage OVM si la transition prétend sauter directement de l'allostasie (R3) à l'Institution inférentielle normative (R13).
...
Il détecte les violations de frontières descriptives. Il s'assure par exemple que les modèles cognitifs (R5) ne s'approprient pas la dimension purement matérielle et organique de l'allostasie en la réduisant abusivement à du calcul abstrait, garantissant ainsi l'intégrité de l'infrastructure Proto.
...
P -. Tension T2 .-> R5_FEP[R5]
P -. Tension T4 .-> R11[R11]
```
...
Fichier : R3_ajustement_allostatique_damasio_sterling.md

Connexions principales : R2, R5, R6, R7, R10, R11, R12
